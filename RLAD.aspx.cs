...
protected void btnreservarlad_Click(object sender, EventArgs e)
 {
        try
        {
            ...
            lblmensaje1.Text = "Sus datos fueron guardados correctamente";
        ...
        catch (Exception)
        {
            ...
            lblmensaje1.Text = "Los datos no fueron guardados correctamente";
        }
    }
